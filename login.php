...
<html lang="en">
  ...
  <link rel="shortcut icon" type="text/css" href="img/logobpn.png">
  ...
  <body class="background-img">
    ...
    <div class="container mt-4 mb-3 rounded">
      <div class="row justify-content-center">
        <div class="col-lg-4 bg-transparent p-4 login">

          <h3 class="card-text text-center">Aplikasi Arsip Dokumen Cetak</h3>

          <div class="card text-center border-0">
            <img src="img/logobpn.png" class="card-img-top mx-auto">
            <div class="card-body">
            </div>
          </div>
          <?php if ( isset($error)) : ?>
